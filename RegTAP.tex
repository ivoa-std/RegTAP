...
\def\rtent{\begingroup\catcode\_[1]{\texttt{\color{rtcolor} #1}}
...
1.1 Erratum 1).
\item Adding \rtent{stc\_spatial}, \rtent{stc\_temporal}, and
\rtent{stc\_spectral} tables and a sample query illustrating their use.
